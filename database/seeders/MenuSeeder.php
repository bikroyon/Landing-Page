...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 8, 'parent_id' => null, 'name' => 'Reports', 'slug' => 'reports', 'href' => '#', 'icon' => 'mdi:report-box', 'sequance' => 8, 'status' => 1],
            ...
            ['id' => 10, 'parent_id' => null, 'name' => 'Store Settings', 'slug' => 'store-settings', 'href' => '/store-settings', 'icon' => 'material-symbols:settings-rounded', 'sequance' => 10, 'status' => 1],
            ['id' => 11, 'parent_id' => null, 'name' => 'supports', 'slug' => 'supports', 'href' => '/supports', 'icon' => 'streamline-ultimate:headphones-customer-support-question-bold', 'sequance' => 11, 'status' => 1],
            ['id' => 12, 'parent_id' => null, 'name' => 'OthersPages', 'slug' => 'pages', 'href' => '/pages', 'icon' => 'material-symbols:web-stories', 'sequance' => 12, 'status' => 1],
            ['id' => 13, 'parent_id' => null, 'name' => 'Roles Permission', 'slug' => 'roles-permission', 'href' => '/roles', 'icon' => 'mdi:shield-key', 'sequance' => 13, 'status' => 1],
            ['id' => 14, 'parent_id' => null, 'name' => 'Customizations', 'slug' => 'customizations', 'href' => '#', 'icon' => 'mingcute:switch-fill', 'sequance' => 14, 'status' => 1],
            ...
            //SubMenu for Reports
            ['id' => 20, 'parent_id' => 8, 'name' => 'Sales Report', 'slug' => 'sales-report', 'href' => '/reports/sales', 'icon' => 'solar:graph-up-bold', 'sequance' => 20, 'status' => 1],
            ['id' => 21, 'parent_id' => 8, 'name' => 'Customer Report', 'slug' => 'customers-report', 'href' => '/reports/customer', 'icon' => 'fa:users', 'sequance' => 21, 'status' => 1],
            ['id' => 22, 'parent_id' => 8, 'name' => 'Products Report', 'slug' => 'products-report', 'href' => '/reports/products', 'icon' => 'solar:cart-5-bold', 'sequance' => 22, 'status' => 1],
