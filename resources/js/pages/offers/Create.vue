  ...
  <div class="p-6 max-w-4xl mx-auto">
    ...
    <form @submit.prevent="submit" class="space-y-5 bg-white p-6 rounded-lg shadow">
      ...
      <div>
        ...
        <div v-if="form.errors.offer_type" class="text-red-600 text-sm mt-1">{{ form.errors.offer_type }}</div>
      </div>
      ...
      <div>
        ...
        />
        <div v-if="form.errors.discount_value" class="text-red-600 text-sm mt-1">{{ form.errors.discount_value }}</div>
      </div>
      ...
      <div>
        ...
        <div v-if="form.errors.product_id" class="text-red-600 text-sm mt-1">{{ form.errors.product_id }}</div>
      </div>

      <!-- Usage Limit -->
      <div>
        <label class="block font-medium mb-1">Usage Limit (optional)</label>
      ...
      <div class="flex justify-end">
        ...
        >
          {{ form.processing ? 'Saving...' : 'Save Offer' }}
        </button>
      </div>
    </form>
  </div>
