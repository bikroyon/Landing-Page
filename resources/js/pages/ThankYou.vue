                    ...
                    >
                        <div>
                            ...
                            <span v-if="item.variant_index !== null">
                                ({{
                                    item.product.variations[item.variant_index]
                                        .name
                                }})
                            </span>
                            <span
                                v-if="item.extra_price && item.extra_price > 0"
                            >
            ...
            <div class="mt-4">
                <Link :href="buttonUrl">
                    <Button>
                        {{
                            userExists
                                ? 'Login & Track My Order'
                                : 'Register & Track My Order'
                        }}
                    </Button>
                </Link>
            </div>
...
const props = defineProps<{ order: any; userExists: boolean }>();
const page = usePage();
